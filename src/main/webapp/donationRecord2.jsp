...
<html>
<head>
<link rel="stylesheet" href="donationRecord2.css">
...
<div class='container'>
<div align ="center">
<h1>Transaction Record (Project ID: 1002) </h1>
...
String sql = "SELECT * FROM transaction where project_id ='1002' and project_block = (select max(project_block) from transaction where project_id = '1002')";
...
<button class="glow-on-hover" onclick="location.href ='charityRecord2.jsp'">View All Transaction Records (Project ID: 1002)</button>
