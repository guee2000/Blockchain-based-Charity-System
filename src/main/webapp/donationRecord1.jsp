...
<html>
<head>
<link rel="stylesheet" href="donationRecord1.css">
...
<div class='container'>
<div align ="center">
<h1>Transaction Record (Project ID: 1001) </h1>
...
String sql = "SELECT * FROM transaction where project_id ='1001' and project_block = (select max(project_block) from transaction where project_id = '1001')";
...
<button class="glow-on-hover" onclick="location.href ='charityRecord1.jsp'">View All Transaction Records (Project ID: 1001)</button>
