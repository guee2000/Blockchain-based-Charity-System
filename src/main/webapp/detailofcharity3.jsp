...
<html>
<head>
<link rel="stylesheet" href="detailofcharity3.css">
...
<h3> 10000 George Town, Pulau Pinang.</h3>


<button class="glow-on-hover" onclick="location.href ='charitydonate3.jsp'">Donate</button>
<button class="glow-on-hover" onclick="location.href ='charityRecord3.jsp'">View All Transaction Records</button>
